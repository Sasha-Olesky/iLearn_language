...
<div class="nicdark_display_table nicdark_transition_all_08_ease nicdark_navigation_4_search_content nicdark_bg_greydark_alpha_9 nicdark_position_fixed nicdark_width_100_percentage nicdark_height_100_percentage nicdark_z_index_1_negative nicdark_opacity_0">

    <!--close-->
    <div class="nicdark_cursor_zoom_out nicdark_navigation_4_close_search_content nicdark_width_100_percentage nicdark_height_100_percentage nicdark_position_absolute nicdark_z_index_1_negative"></div>
...
<div class="nicdark_navigation_4_sidebar_content nicdark_padding_40 nicdark_box_sizing_border_box nicdark_overflow_hidden nicdark_overflow_y_auto nicdark_transition_all_08_ease nicdark_bg_green nicdark_height_100_percentage nicdark_position_fixed nicdark_width_300 nicdark_right_300_negative nicdark_z_index_9">

    <img alt="" width="25" class="nicdark_close_navigation_4_sidebar_content nicdark_cursor_pointer nicdark_right_20 nicdark_top_20 nicdark_position_absolute" src="img/icons/icon-close-white.svg">



    <div class="nicdark_navigation_4_sidebar">
        <ul>
            <li>
...
<div class="nicdark_section nicdark_position_absolute nicdark_margin_top_20">
...
<div class="nicdark_section nicdark_position_relative">
    ...
    <div class="nicdark_section">
        ...
        <div class="nicdark_container nicdark_clearfix nicdark_bg_greydark nicdark_border_radius_3_3_0_0">

            <div class="grid grid_6 nicdark_padding_botttom_10 nicdark_padding_top_10 nicdark_text_align_center_responsive">

              
                <div class="nicdark_navigation_top_header_4">
                    <ul>
                        <li>
...
<div class="nicdark_section nicdark_position_relative ">
    ...
    <div class="nicdark_section">
        ...
        <!--start nicdark_container-->
        <div class="nicdark_container nicdark_padding_0_20_responsive nicdark_box_sizing_border_box nicdark_bg_white nicdark_clearfix nicdark_position_relative nicdark_border_radius_0_0_3_3">
            ...
            <div class="grid grid_12 nicdark_display_none_all_responsive">
                ...
                <!--LOGO-->
                <a href="index.php"><img alt="" class="nicdark_position_absolute nicdark_left_15 nicdark_top_20" width="170" src="<?php echo base_url();?>img/logos/logo-foodlab-grey.svg"></a>
                ...
                <div class="nicdark_float_right nicdark_width_100  nicdark_position_relative nicdark_height_25 nicdark_display_none_all_responsive">
                    ...
                    <a href="cart.php">
                        <img alt="" class="nicdark_opacity_05_hover nicdark_transition_all_08_ease nicdark_position_absolute nicdark_top_3_negative nicdark_left_0 nicdark_margin_left_20" width="25" src="<?php echo base_url();?>img/icons/icon-cart-grey.svg">
                    </a>
                    ...
                    <a class="nicdark_navigation_4_open_search_content" href="#"><img alt="" class="nicdark_opacity_05_hover nicdark_transition_all_08_ease nicdark_position_absolute nicdark_top_3_negative nicdark_right_0" width="25" src="<?php echo base_url();?>img/icons/icon-search-grey.svg"></a>

                </div>
                <!--right icons menu-->


                <div class="nicdark_navigation_4 nicdark_text_align_right nicdark_float_right nicdark_display_none_all_responsive">
                    <ul>
                        <li>
                            <a href="index.php">HOME</a>
            ...
            <div class="nicdark_width_50_percentage nicdark_text_align_center_all_iphone nicdark_width_100_percentage_all_iphone nicdark_float_left nicdark_display_none nicdark_display_block_responsive">
                ...
                <a href="index.php"><img alt="" width="170" class="" src="img/logos/logo-foodlab-grey.svg"></a>   
            </div>
            <div class="nicdark_width_50_percentage nicdark_width_100_percentage_all_iphone nicdark_float_left nicdark_display_none nicdark_display_block_responsive">
                ...
                <div class="nicdark_float_right nicdark_width_100_percentage nicdark_text_align_right nicdark_text_align_center_all_iphone">
                    ...
                    <a class="nicdark_open_navigation_4_sidebar_content" href="#">
                    ...
                    <div class="nicdark_position_relative nicdark_display_inline_block">
                        <a href="cart.php"><img alt="" width="25" src="img/icons/icon-cart-grey.svg"></a> 
                    ...
                    <img alt="" class="nicdark_margin_left_20 nicdark_navigation_4_open_search_content" width="25" src="img/icons/icon-search-grey.svg"> 
