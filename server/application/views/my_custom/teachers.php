                                            ...
                                            <div class="nicdark_bg_greydark_alpha_gradient nicdark_position_absolute nicdark_left_0 nicdark_height_100_percentage nicdark_width_100_percentage nicdark_padding_20 nicdark_box_sizing_border_box">
                                                ...
                                                <div class="nicdark_position_absolute nicdark_bottom_20">
                                                    <div class="nicdark_display_inline_block">
                                                        <img alt="" width="15" class="nicdark_margin_right_10" src="<?php echo base_url();?>img/icons/icon-twitter-white.svg">
                                                        <img alt="" width="15" class="nicdark_margin_right_10" src="<?php echo base_url();?>img/icons/icon-pinterest-white.svg">
                                                        <img alt="" width="15" class="nicdark_margin_right_10" src="<?php echo base_url();?>img/icons/icon-linkedin-white.svg">
                                                        <img alt="" width="15" class="nicdark_margin_right_10" src="<?php echo base_url();?>img/icons/icon-google-white.svg">
                                                        <img alt="" width="15" class="nicdark_margin_right_10" src="<?php echo base_url();?>img/icons/icon-instagram-white.svg">
                                                    </div>
                                                </div>
                                            </div>
